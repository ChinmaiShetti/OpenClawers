...
export default function BadDeedsPage() {
  return (
    <div className="min-h-screen bg-[#0f172a] text-slate-100 max-w-4xl mx-auto px-4 py-8">
      ...
      <h1 className="text-2xl font-bold mb-2 text-red-400">BadDeeds Module</h1>
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-8 text-center text-slate-500">
        <p className="font-medium text-slate-300 mb-2">BadDeeds — coming soon</p>
